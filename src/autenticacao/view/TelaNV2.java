...
import autenticacao.controller.DadosFiscaisController;
import util.RoundedBorder;

/**
 * Tela onde é exibida as informações fiscais de uma produtora agrícola.
 *
 */
public class TelaNV2 {
	...
	public TelaNV2(TelaInicial telaInicial) {
	...
	private void initialize() {
		...
		lbTitulo = new JLabel("Informações Fiscais");
		...
		cbxProdutoras.setModel(new DefaultComboBoxModel<String>(new String[] {"Selecione uma opção..", "Amaggi", "SLC Agrícola", "Bom Futuro", 
				"Informações da Produção Agrícola"}));
...
//		spRolagemInformacoes.setBorder(new LineBorder(new Color(193, 193, 193), 1, true));
	...
	/**
	 * Retorna as informações fiscais de uma produtora agrícola, consultando-as 
	...
	private void consultar() {
		...
		case 1:
			taInformacoes.setText(DadosFiscaisController.consultarDadosFiscais(1).toString());
			break;
		case 2:
			taInformacoes.setText(DadosFiscaisController.consultarDadosFiscais(2).toString());
			break;
		case 3:
			taInformacoes.setText(DadosFiscaisController.consultarDadosFiscais(3).toString());
			break;
		case 4:
			this.frame.dispose();
